...
module.exports.getAll = function(tabName, handler) {
    util.notStringException(tabName, "Module dao => tabName must be a string value.");
...
module.exports.getById = function(tabName, id, handler) {
    util.notStringException(tabName, "Module dao => tabName must be a string value.");
    util.notNumberException(id, "Module dao => id must be a number value.");
    if (fs.existsSync(file)) {
        var db = new sqlite3.Database(file);
...
module.exports.search = function(tabName, colonnes, values, handler) {
    util.notStringException(tabName, "Module dao => tabName must be a string value.");
    util.notArrayException(colonnes, "Module dao => colonnes must be an array value.");
    util.notArrayException(value, "Module dao => values must be an array value.");
...
module.exports.insert = function(tabName, colonnes, value, handler) {
    util.notStringException(tabName, "Module dao => tabName must be a string value.");
    util.notArrayException(colonnes, "Module dao => colonnes must be an array value.");
    util.notObjectException(value, "Module dao => values must be an object value.");
...
module.exports.update = function(tabName, colonnes, value, handler) {
    ...
    util.notArrayException(colonnes, "Module dao => colonnes must be an array value.");
    util.notObjectException(value, "Module dao => values must be an object value.");
    util.nullOrUndefinedException(value['id'], "Module dao => values must be an object value.");
    ...
    var indexColonnes = queryColonnes.lastIndexOf(',');
    if (indexColonnes > 0) {
        queryColonnes = queryColonnes.slice(0, index);
    }
    queryColonnes += " ";
...
module.exports.exc = function(query, params, handler) {
    util.notStringException(query, "Module dao => query must be a string value.");
    var expr = (util.isNotNullOrUndefined(params) && util.isNotArray(params));
    util.argumentException(expr, "Module dao => bad type params.");
    if (fs.existsSync(file)) {
        var db = new sqlite3.Database(file);
